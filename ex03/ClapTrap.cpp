...
/*   Updated: 2024/05/17 15:35:01 by lgernido         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap()
{
    std::cout << BOLD << "Clap Trap " << RESET << ITALIC << "destructor" << RESET << " called" << std::endl;
    std::cout << std::endl;
}
...
{
    std::cout << BOLD << "Clap Trap " << RESET << ITALIC << "copy constructor " << RESET << "called" << std::endl;
...
{
    std::cout << BOLD << "Clap Trap " << RESET << ITALIC << "Name constructor" << RESET << " called" << std::endl;
    std::cout << std::endl;
}
